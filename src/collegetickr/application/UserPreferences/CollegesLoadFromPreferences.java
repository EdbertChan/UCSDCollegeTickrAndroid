...
public class CollegesLoadFromPreferences extends
		MultiSelectListPreferenceCompat implements
	...
	private void initializeValues() {
		...
		ArrayList<University> listLoadFrom = new ArrayList(
				UserPreferenceDefaultSettingsClass.getLoadFrom());
		...
		/*
		 * CharSequence[] entries = { "English", "French" }; CharSequence[]
		 * entryValues = {"1" , "2"}; setEntries(entries); //
		 * setDefaultValue("1");
		 * 
	...
	protected void onPrepareDialogBuilder(Builder builder) {
		...
		/*
		 * final EditText input = new EditText(context); builder.setView(input);
		 */
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		...
		UserPreferenceDefaultSettingsClass.mergeSetLoadFrom(newSets);
	...
	/*
	 * @Override public CharSequence getSummary() { final CharSequence entry =
	 * getEntry(); final CharSequence summary = super.getSummary(); if (summary
	 * == null || entry == null) { return null; } else { return
	 * String.format(summary.toString(), entry); } }
	 * 
