...
public abstract class ComplimentsConfessionsFragmentBaseClass extends Fragment  implements AsyncTaskCompleteListener  {
		...
		if (mPager != null) {
			...
			buttonViewContent.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//for now, load all
					if(IdentifiersList.LOAD_ALL_AT_ONCE){
						getAllContent();
					}
	...
	public void onTaskComplete(Object result) {
		...
		//(PostAndCommentingWithAdapterFragmentBaseClass)(this.getParentFragment()).
	...
	/*	outState.putInt(
				...
				buttonCancelUploadImage.getVisibility());
		outState.putInt(
