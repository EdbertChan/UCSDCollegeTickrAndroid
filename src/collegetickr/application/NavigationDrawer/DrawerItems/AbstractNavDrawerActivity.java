	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
			...
			public void onDrawerSlide(View drawerView, float slideOffset) {
				// we hide the keyboard on the slide open. Maybe we can improve
				// the performance by making the call
				// fragment specific? However, how can we call it from the
				// fragment? This needs
				// to be researched more
				InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);

				// alternatively, we can call the View on mDrawerList's current
				// position
