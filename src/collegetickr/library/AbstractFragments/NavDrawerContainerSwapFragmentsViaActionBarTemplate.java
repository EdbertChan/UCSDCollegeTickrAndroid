...
public abstract class NavDrawerContainerSwapFragmentsViaActionBarTemplate
		extends Fragment {
	int rootLayout, containerLayoutId;// =
										// R.layout.compliments_confessions_container_layout;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		// we assume that all keys are unique. Code may need to be modified in
		// the case that it isnt,
		...
		if (childFragmentManager != null) {
			...
			for (Fragment childFragment : nestedFragments) {
				if (childFragment != null && !childFragment.isDetached()
					...
					// need to generate a unique requestCode for each instance
					// of the class. This seems really
					// inefficient.
					childFragment.onActivityResult(requestCode, resultCode,
							data);
				}
			}
		}
